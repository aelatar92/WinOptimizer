...
function Show-Services-Menu {
    Clear-Host
    Write-WinOptHost '=== Windows Services Manager ===' -ForegroundColor Yellow
    Write-WinOptHost '1. List catalog   2. Disable service   3. Start service   4. Back' -ForegroundColor White
}
    ...
    switch ($c) {
        '1' {
            foreach ($s in $ServiceCatalog) {
                ...
                Write-WinOptHost "$($s.Name) [$st] - $($s.Desc) (risk: $($s.Risk))" -ForegroundColor Gray
            }
        }
        '2' {
            ...
            Write-WinOptHost "Disabled $name" -ForegroundColor Green
        ...
        '3' {
            ...
            Write-WinOptHost "Started $name" -ForegroundColor Green
        }
        '4' { break }
    }
