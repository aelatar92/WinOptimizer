...
$script:WinOptStrings = @{
    en = @{
        ...
        ai_local_disabled    = 'Local AI is not set up. Go to Settings (15) -> 8 to enable it (requires Ollama running locally).'
    ...
    ar = @{
        ...
        ai_local_disabled    = 'الذكاء الاصطناعي المحلي غير مُعد. اذهب للإعدادات (15) -> 8 لتفعيله (يتطلب تشغيل Ollama محليًا).'
